...
- [Завдання 2: Виконання cat /etc/shadow від адміністратора](#завдання-2-виконання-cat-etcshadow-від-адміністратора)
...
## Завдання 2: Виконання cat /etc/shadow від адміністратора
